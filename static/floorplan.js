class Floorplan {
    ...
    selectPoint(pnt, ctx, _draw=true){
    ...
    updatePathsAndPoints(invName, add=true){
        ...
        this.pointsMap.get('node_0').draw = true;
        var points = structuredClone(this.pointPaths);
        this.updatePaths('node_0', points);
        this.draw(this.ctx);
    }
